...
<div class="page-builder">
	<div class="container">
		...
		get_template_part('content',''); ?>
				<!--Blog Author-->
				<div class="comment-title" style="display:none;"><h3><?php _e('About the author','appointment'); ?></h3></div>
				...
				if ( $linkedin_profile && $linkedin_profile != '' ) {
					   echo '<li class="linkedin"><a href="' . esc_url($linkedin_profile) . '"><i class="fa fa-instagram"></i></a></li>';
				}
