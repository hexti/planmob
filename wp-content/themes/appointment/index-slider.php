		...
		<div class="carousel-inner" role="listbox">
			...
			<?php
				...
				foreach ($recent_posts as $item) {
					...
					//<div class="slide-text-bg2"><span>'.$item['post_title'].'</span></div>
					echo '<div class="item '.$active.'">
						   <img src="'.$image[0].'">
							<div class="container slide-caption">
								<div class="slide-text-bg1"><h2>'.$item['post_title'].'</h2></div>
									
								<div class="slide-btn-area-sm"><a href="'.get_permalink($item["ID"]).'" class="slide-btn-sm">Leia mais</a></div>		
							</div>
						</div>';
					$active  = '';
				}
