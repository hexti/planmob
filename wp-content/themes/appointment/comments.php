...
<div class="comment-section">asdsad
	...
	<?php  
	 $fields=array(
		...
		add_filter('comment_form_default_fields','appointment_fields');
			...
			'logged_in_as' => '<p class="blog-post-info-detail">' . __( "",'appointment' ).'<a href="'. admin_url( 'profile.php' ).'">'.$user_identity.'</a>'. '<a href="'. wp_logout_url( get_permalink() ).'" title="'.__('Logout from this Account','appointment').'">'.__("",'appointment').'</a>' . '</p>',
